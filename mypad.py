...
class MyPad:
	...
	def __init__(self,**kwargs):
		...
		self.__thisEditMenu.add_command(label = "Undo", command = None, accelerator = "Ctrl + Z")
		self.__thisEditMenu.add_command(label = "Redo", command = None, accelerator = "Ctrl + Y")
		...
		self.__thisEditMenu.add_command(label = "Select All", command = None, accelerator = "Ctrl + A")
		...
		self.__thisSearchMenu.add_command(label = "Find", command = None, accelerator = "Ctrl + F")
		self.__thisSearchMenu.add_command(label = "Find & Replace", command = None, accelerator = " Ctrl + H")
